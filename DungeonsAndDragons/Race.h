...
private:
	...
	string alignArray[8] = { "Lawful Good", "Neutral Good", "Chaotic Good", "Lawful Neutral", "Neutral", "Chaotic Neutral", "Lawful Evil", "Neutral Evil" };
public:
	string getName();
	void human(int[]);
	void dwarf(int&);
	void hillDwarf(int&, int, int);
...
void setRace::human(int stats[]) {
	...
	cin >> age;
	cout << "Humans thend toward no particular alignment. The best and the worst are found among them." << endl;
	cout << "Please pick your alignment: 1)Lawful Good, 2)Neutral Good, 3)Chaotic Good, 4)Lawful Neutral,\n 5)Neutral, 6)Chaotic Neutral, 7)Lawful Evil, 8)Neutral Evil: ";
	cin >> alignPick;
	while (alignPick < 0 && alignPick>8) {
		cout << "Error: " << endl;
		cout << "Please pick your alignment: 1)Lawful Good, 2)Neutral Good, 3)Chaotic Good, 4)Lawful Neutral,\n 5)Neutral, 6)Chaotic Neutral, 7)Lawful Evil, 8)Neutral Evil: ";
		cin >> alignPick;
	}
	alignment = alignArray[alignPick - 1];
	...
	cout << "1)Dwarvish, 2)Elvish, 3)Giant, 4)Gnomish, 5)Goblin, 6)Halfling, 7)Orc : ";
	cin >> langChoice;
...
void setRace::dwarf(int &con) {
	...
	cout << "Please pick your alignment: 1)Lawful Good, 2)Neutral Good,\n 3)Chaotic Good, 4)Lawful Neutral, 5)Neutral,\n 6)Chaotic Neutral, 7)Lawful Evil, 8)Neutral Evil: ";
	cin >> alignPick;
	while (alignPick < 0 && alignPick>8) {
		cout << "Error: " << endl;
		cout << "Please pick your alignment: 1)Lawful Good, 2)Neutral Good,\n 3)Chaotic Good, 4)Lawful Neutral, 5)Neutral,\n 6)Chaotic Neutral, 7)Lawful Evil, 8)Neutral Evil: ";
...
void setRace::hillDwarf(int &wis, int hp, int level) {
	wis += 1;
	race = "Hill Dwarf";
	hp = hp + level;
...
void setRace::halfling(int &dex) {
	...
	cin >> weight;
	speed = 25;
	cout << "Please pick your alignment: Lawful Good, Neutral Good, Chaotic Good, Lawful Neutral,\n Neutral, Chaotic Neutral, Lawful Evil, Neutral Evil: ";
	cin >> alignment;
	vision = "Normal";
	language.push_back("Common");
...
void setRace::dragonborn(int &str, int& cha) {
	...
	cout << "1)Black, 2)Blue, 3)Brass, 4)Bronze, 5)Copper, 6)Gold, 7)Green, 8)Red, 9)Silver, 10)White: ";
	cin >> type;
...
void setRace::halfElf(int &cha, int &score2, int &score3) {
	cha += 2;
	score2 += 1;
	score3 += 1;
	speed = 30;
